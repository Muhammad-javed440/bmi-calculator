...
export default function BmiCalculator() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-yellow-100 dark:bg-gray-900">
      {/* Center the BMI calculator card within the screen */}
      <Card className="w-full max-w-md mx-auto bg-yellow-50">
        <CardHeader>
